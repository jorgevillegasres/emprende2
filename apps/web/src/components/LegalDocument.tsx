    ...
    <main className="legal-page">
      ...
      <article className="legal-content">
        ...
        <div className="legal-disclaimer" role="note">
          <strong>Borrador para revision.</strong> Este documento es una plantilla base. Antes de publicarlo, completa los
          datos entre corchetes y revisa el contenido con tu criterio juridico.
        </div>
