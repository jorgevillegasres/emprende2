...
const CONTACT = "jorgeavillegas13@gmail.com";
const ENTITY = "BITBROS S.A.S.";
  ...
  terms: {
    ...
    sections: [
      ...
      },
      {
        ...
        paragraphs: [
          "Estos Terminos se rigen por las leyes de la Republica de Colombia. Cualquier controversia se resolvera ante los jueces competentes de Cali (Valle del Cauca).",
    ...
    sections: [
      {
        ...
        paragraphs: [
          "Responsable: " + ENTITY + ", identificada con NIT 901.309.394-3, domiciliada en Cali (Valle del Cauca), Colombia. Canal de atencion: " + CONTACT + "."
        ]
      },
      {
